...
<div id="wrapper">
   ...
   <table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        $select_comments = mysqli_query($connection, $query); // mysqli_real_escape_string prevents any malicious scripting
...
if(isset($_GET['approve'])) {
    ...
    header("Location: post_comments.php?id=". $_GET['id'] .""); // Reloads page for action to happen with one click
}
