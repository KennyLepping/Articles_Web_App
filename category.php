            ...
            <div class="col-md-8">
               ...
               <?php 
                ...
                if(is_admin($_SESSION['username'])) {
                    ...
                    $stmt1 = mysqli_prepare($connection, "SELECT post_id, post_title, post_user, post_date, post_image, post_content FROM posts WHERE post_category_id = ?"); // Prepared statement
                } else {
                    ...
                    $published = 'published'; // Prepared statement
                ...
                // While loop for iterating through post info from the the posts table
